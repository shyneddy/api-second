...
class ProductController {
    ...
    getDetail(req, res) {
        ...
        connection.query(query, [book_id], (error, results) => {
            ...
            if (req.userjwt.user_id) {
                const favorite_query = 'SELECT * FROM `favorites` WHERE user_id = ? and book_id = ?'

                connection.query(favorite_query, [req.userjwt.user_id, book_id], (error, results) => {
                    if (error) {
                    ...
                    connection.query(query, [book_id], (error, results) => {
                        ...
                        connection.query(query, [book_id], (error, results) => {
                            ...
                            if (req.userjwt.user_id) {
                                ...
                                connection.query(query, [req.userjwt.user_id, book_id], (error, results) => {
                                    if (error) {
                                        console.error('Lỗi truy vấn:', error);
                                        return;
                                    }
